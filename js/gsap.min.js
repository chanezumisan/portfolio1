...
!(function (t, e) {
	...
	var Nt,
		...
		Wt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
			...
			var d,
				...
				_ = s(c) ? (l ? re : te) : Zt;
			if (
				(r(n) && (~n.indexOf("random(") && (n = ob(n)), "=" === n.charAt(1) && ((!(d = ka(p, n) + (Ya(p) || 0)) && 0 !== d) || (n = d))), !f || p !== n || Gt)
			)
				return isNaN(p * n) || "" === n
					? (c || e in t || Q(e, n),
				...
				if (p) {
					...
					!(function _renderZeroDurationTween(t, e, r, i) {
						...
						if (
							...
							for (
								s = t._zTime, t._zTime = e || (r ? X : 0), r = r || (e && !s), t.ratio = u, t._from && (u = 1 - u), t._time = 0, t._tTime = l, n = t._pt;
								n;
	...
	function de(t) {
		var e = t.split(" "),
			...
			i = e[1] || "50%";
		return (
			("top" !== r && "bottom" !== r && "left" !== i && "right" !== i) || ((t = r), (r = i), (i = t)), (e[0] = Tr[r] || r), (e[1] = Tr[i] || i), e.join(" ")
		);
	}
	function ee(t, e) {
	...
	var Ee,
		...
		Or = function _parseTransform(t, e) {
			...
			return (
				...
				(r.x =
					i -
					((r.xPercent = i && ((!e && r.xPercent) || (Math.round(t.offsetWidth / 2) === Math.round(-i) ? -50 : 0))) ? (t.offsetWidth * r.xPercent) / 100 : 0) +
					"px"),
				(r.y =
					n -
								...
								if (
									...
									if ("transformOrigin" === d) {
										b.push(pr, 0, x[pr]),
											...
											v.svg
												? le(t, o, 0, y, 0, this)
												: ((p = parseFloat(o.split(" ")[2]) || 0) !== v.zOrigin && Yd(this, v, "zOrigin", v.zOrigin, p), Yd(this, x, d, kr(s), kr(o)));
										continue;
									}
									if ("svgOrigin" === d) {
										le(t, o, 1, y, 0, this);
